...
public enum ErrorCode {
    ...
    INPUT_ITEM_PRICE_UNDER_MIN("상품 가격은 100원부터 시작한다,", Constant.INPUT_EXCEPTION),
    INPUT_ITEM_PRICE_MOD_FAIL("상품 가격은 10원으로 나누어떨어져야 한다.", Constant.INPUT_EXCEPTION),
        
    // 76 "금액은 숫자여야 합니다."
    INPUT_BALANCE_NUMBER_FORMAT("금액은 숫자여야 합니다.", Constant.INPUT_EXCEPTION),
