...
class ApplicationTest extends NsTest {
    ...
    void 기능_테스트_2() {
        assertRandomNumberInListTest(() -> {
            run("811", "[콜라,15000,20];[사이다,10000,10]", "4321");
            assertThat(output()).contains("자판기가 보유한 동전", "500원 - 1개", "100원 - 1개", "50원 - 1개", "10원 - 16개",
                    "투입 금액: 4321원", "100원 - 1개", "50원 - 1개", "10원 - 16개");
        }, 500, 100, 50, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10);
    }
